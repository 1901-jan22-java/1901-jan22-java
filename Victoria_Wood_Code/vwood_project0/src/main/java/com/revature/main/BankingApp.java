...
public class BankingApp {
	...
	static void viewAccounts(User user) {
		...
		if (useraccts.size() > 1) {
			...
			// display info of table of choice - 1 index - maybe create separate choose acct method
		}
	}
		...
		System.out.println("What type of account would you like to create, " + c.getFn() + "?\n"
		...
		Account a = AccountRepository.addAccount(c.getId(), type, deposit);
