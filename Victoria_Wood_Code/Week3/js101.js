...
-TRUTHY AND FALSY
    ...
    evaluated as conditions in control statements
    - FALSY - false, null, 0, undefined NaN, ""
    - TRUTHY - everything else
- typer coersion - the process that JS takes to bring data from
one type to another to compare the actual value as opposed to the
datatype
*/
