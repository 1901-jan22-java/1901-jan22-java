	...
	public Connection getConnection() {
		...
		try {
			...
			conn = DriverManager.getConnection(
					...
					//prop.getProperty("jdbc:oracle:thin:@dbleigaray.cddn4hufokqi.us-east-2.rds.amazonaws.com:1521/ORCL"),
					prop.getProperty("usr"),
					prop.getProperty("pwd"));*/
			conn = DriverManager.getConnection
					("jdbc:oracle:thin:@dbleigaray.cddn4hufokqi.us-east-2.rds.amazonaws.com:1521/ORCL","dbleigaray","dbleigaray");
