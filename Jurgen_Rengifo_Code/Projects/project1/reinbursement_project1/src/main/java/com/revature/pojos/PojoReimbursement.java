...
public class PojoReimbursement implements Serializable {
	...
	public PojoReimbursement() {
		super();
	}

	public PojoReimbursement(Double amount, Date submitted, Date resolved, String reimb_description, Receipt receipt,
			Integer author_id, Integer resolver_id, Integer reimb_status_id, Integer reimb_type_id) {
		super();
		this.amount = amount;
	...
	public PojoReimbursement(Integer reimb_id, Double amount, Date submitted, Date resolved, String reimb_description,
